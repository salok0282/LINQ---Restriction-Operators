...
namespace LinqRestrictionOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            LinqRestrictionOperatorSamples objSamples = new LinqRestrictionOperatorSamples();

            //Uncomment the method calls below that you want to run or execute


            //objSamples.RestrictionOperatorExaple1(); // Uses of where clause to find all elements of an array with a value greater than 6.

            //objSamples.RestrictionOperatorExaple2(); // Uses of where clause to find all products that have out of stock.

            objSamples.RestrictionOperatorExaple3(); // Uses of where clause to find all products that are in stock and Category is Beverages.


            //objSamples.RestrictionOperatorExaple5();; // This sample demonstrates an indexed where clause that returns digits whose name is 
        ...
        public class LinqRestrictionOperatorSamples
        {
            private List<Product> productList; // i have created product class and created product on it
            
            [Description("This sample uses of where clause to find all elements of an array with a value greater than 6.")]
            public void RestrictionOperatorExaple1()
            {
            ...
            [Description("Uses of where clause to find all products that have out of stock.")]
            public void RestrictionOperatorExaple2()
            {
                ...
                Console.WriteLine("products list that are Sold out :");
                foreach (var pd in productsSoldOut)
                {
                    Console.WriteLine("{0} is sold out!", pd.ProductName);
                }
                Console.ReadLine();
            }

            [Description("Uses of where clause to find all products that are in stock and Category is Beverages.")]
            public void RestrictionOperatorExaple3()
            {
                List<Product> products = GetProductList();

                var BeveragesInStockProducts =
                    from p in products
                    where p.UnitsInStock > 0 && p.Category == "Beverages" && p.UnitPrice>5
                    select p;

                Console.WriteLine("In-stock products that Category is Beverages:");
                foreach (var pd in BeveragesInStockProducts)
                {
                    Console.WriteLine("{0} is in stock and Category is Beverages.", pd.ProductName);
                }
                Console.ReadLine();
            }
            ...
            public void RestrictionOperatorExaple5()
            {
            ...
            private void createLists()
            {
                ...
                productList =
                    new List<Product> {
                    new Product { ProductID = 1, ProductName = "Aam panna", Category = "Beverages", UnitPrice = 18.0000M, UnitsInStock = 39 },
                    new Product { ProductID = 2, ProductName = "Apong", Category = "Beverages", UnitPrice = 19.0000M, UnitsInStock = 17 },
                    ...
                    new Product { ProductID = 24, ProductName = "Coconut water", Category = "Beverages", UnitPrice = 4.5000M, UnitsInStock = 20 },
                    ...
                    new Product { ProductID = 34, ProductName = "Fruit jump", Category = "Beverages", UnitPrice = 14.0000M, UnitsInStock = 111 },
                    new Product { ProductID = 35, ProductName = "Gajjar ka doodh", Category = "Beverages", UnitPrice = 18.0000M, UnitsInStock = 20 },
                    ...
                    new Product { ProductID = 38, ProductName = "Jal-jeera", Category = "Beverages", UnitPrice = 263.5000M, UnitsInStock = 17 },
                    new Product { ProductID = 39, ProductName = "Kala Khatta", Category = "Beverages", UnitPrice = 18.0000M, UnitsInStock = 69 },
                    ...
                    new Product { ProductID = 43, ProductName = "Kulukki sarbath", Category = "Beverages", UnitPrice = 46.0000M, UnitsInStock = 17 },
                    ...
                    new Product { ProductID = 67, ProductName = "Kesar kasturi", Category = "Beverages", UnitPrice = 14.0000M, UnitsInStock = 52 },
                    ...
                    new Product { ProductID = 70, ProductName = "Kokum sarbat", Category = "Beverages", UnitPrice = 15.0000M, UnitsInStock = 15 },
                    ...
                    new Product { ProductID = 75, ProductName = "Laopani", Category = "Beverages", UnitPrice = 7.7500M, UnitsInStock = 125 },
                    new Product { ProductID = 76, ProductName = "Thandai", Category = "Beverages", UnitPrice = 18.0000M, UnitsInStock = 57 },
