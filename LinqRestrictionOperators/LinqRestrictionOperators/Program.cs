...
namespace LinqRestrictionOperators
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // objSamples.RestrictionOperatorExaple3(); // This sample uses the where clause to find all products that are in  stock and cost 
            // more than 3.00 per unit

            //objSamples.RestrictionOperatorExaple4();; // This sample uses the where  clause to find all customers in Washington and then it 
        ...
        public class LinqRestrictionOperatorSamples
        {
            ...
            public void RestrictionOperatorExaple4()
            {
